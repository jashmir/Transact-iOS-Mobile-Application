                ...
                VStack {
                    ...
                    VStack(spacing: 20) {
                        VStack(alignment: .leading, spacing: 4) {
                            HStack { Spacer() }
                            TextView(text: "ABOUT APP:", type: .overline).foregroundColor(Color.text_primary_color)
                            TextView(text: "Transact is an expense tracker app that helps you manage your daily expenses.", type: .body_2)
                                .foregroundColor(Color.text_secondary_color).padding(.top, 2)
                        }
                        VStack(alignment: .leading, spacing: 4) {
                            HStack { Spacer() }
